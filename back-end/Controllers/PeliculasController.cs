    ...
    public class PeliculasController: ControllerBase
    {
        ...
        public async Task<ActionResult<LandingPageDTO>> Get()
        {
            ...
            var proximosEstrenos = await context.Peliculas
                .Where(x => x.FechaLanzamiento > hoy && x.EnCines == false)
            ...
            var resultado = new LandingPageDTO() { EnCines = mapper.Map<List<PeliculaDTO>>(enCines), ProximosEstrenos = mapper.Map<List<PeliculaDTO>>(proximosEstrenos)};
